...
5. 按任务类型补读：
   ...
   - Service：`../../cool-admin-midway/.cursor/rules/service-template.mdc`、`../../cool-admin-midway/.cursor/rules/service.mdc`
   - 查询 / 分页：`../../cool-admin-midway/.cursor/rules/query-template.mdc`
